...
Route::middleware('auth')->group(function () {
    ...
    //kembali BT SU
    Route::get('kembaliSu/{jenis}/{history_id}/{berkas_id}/{proses_id}', [BerkasController::class, 'kembaliSu'])->name('kembaliSu');
    Route::get('kembaliBt/{jenis}/{history_id}/{berkas_id}/{proses_id}', [BerkasController::class, 'kembaliBt'])->name('kembaliBt');
    //end kembali BT SU
