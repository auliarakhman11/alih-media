    ...
    <div class="col-12 mb-4 order-0">
      ...
      <div class="card">
          <div class="card-header">
              <h5 class="float-start">Input Berkas</h5>
              
          </div>
          
          <div class="card-body">

            <form id="form_input_berkas">
              <div class="row">
                ...
                <div class="col-6 mt-3">
                  <div class="row">
                    ...
                    <div class="col-8">
                      <select class="form-control" name="jenis_hak_id" id="jenis_hak_id" required>
                ...
                <div class="col-6 mt-3">
                    <div class="row">
                      ...
                      <div class="col-8">
                        <input type="number" name="no_hak" id="no_hak" class="form-control" required>
                      </div>
                    </div>
                </div>
                ...
                <div class="col-6 mt-3">
                  <div class="row">
                    <div class="col-4"><label class="float-end" for="no_peta">Nomor SU/GS</label></div>
                    <div class="col-8">
                      <input type="number" name="no_peta" id="no_peta" class="form-control" required>
                    </div>
                  </div>
              </div>
              ...
              <div class="col-6 mt-3">
                <div class="row">
                  <div class="col-4"><label class="float-end" for="tahun_peta">Tahun</label></div>
                  <div class="col-8">
                    <input type="number" name="tahun_peta" id="tahun_peta" class="form-control" required>
                  </div>
                </div>
              </div>
              ...
              <div class="col-6 mt-3">
                <div class="row">
                  <div class="col-4"><label class="float-end" for="nib">NIB</label></div>
                  <div class="col-8">
                    <input type="number" name="nib" id="nib" class="form-control" required>
                  </div>
                </div>
              </div>
              ...
              <div class="col-6 mt-3">
                ...
                <div class="row">
                  ...
                  <div class="col-4">
                    <label class="float-end" for="nib">Jenis</label>
              ...
              <div class="col-6 mt-3">
                <div class="row">
                  <div class="col-4"><label class="float-end" for="nm_pemohon">Upload File</label></div>
                  <div class="col-8">
                    <input type="file" name="file_name" class="form-control" accept="application/pdf, image/png, image/jpeg" id="upload_file" required>
                  </div>
                </div>
              </div>
              ...
              <div class="col-6"></div>
                ...
                <div class="col-6">
                  ...
                  <div class="row">
                    ...
                    <div class="col-12"><button type="submit" class="btn btn-sm btn-primary float-end mt-4" id="btn_input_berkas"><i class="bx bxs-save"></i> Input</button></div>
                  </div>
    ...
    function getKelurahan(kecamatan_id){
      ...
      <script>
        ...
        $(document).ready(function () {
          ...
          $(document).on('submit', '#form_input_berkas', function(event) {
                event.preventDefault();

                    $('#btn_input_berkas').attr('disabled',true);
                    $('#btn_input_berkas').html('Loading..');
                        ...
                        success: function(data) {
                          ...
                          if (data) {
                            Swal.fire({
                                ...
                                $('#tahun_peta').val('');
                                $('#nib').val('');
                                $('input[name=jenis_peta_id]:nth-child(0)').attr('checked', true);
                                $('#upload_file').val('');
      
                                // $.get('getKelurahan/0', function (data) {        
                                //     $('#kelurahan_id').html(data);
                                // });

                                // $('#form_input_berkas').trigger("reset");
                          } else {
                          ...
                          $('#btn_input_berkas').html('<i class="bx bxs-save"></i> Input'); //tombol
