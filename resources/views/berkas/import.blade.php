    ...
    <div class="col-12 mb-4 order-0">
      ...
      <div class="card">
          ...
          <div class="card-body ">
            ...
            <form action="{{ route('importDataSU') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-10"><input type="file" name="file_excel"class="form-control" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" required></div>
                    <div class="col-2"><button type="submit" class="btn btn-sm btn-primary">Save</button></div>
                </div>
            </form>
