                ...
                <table class="table table-sm text-center" width="100%" id="table_berkas" style="font-size: 12px;">
                  <thead>
                    <tr>
                      ...
                      <th style="font-size: 10px;">Tanggal<br>Masuk</th>
                      <th style="font-size: 10px;">Tanggal<br>Selesai</th>
                      <th style="font-size: 10px;">Lama<br>Pengejaan</th>
                  </tr>
                  </thead>
                  <tbody></tbody>
                </table>
            ...
            $('#table_berkas').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        name: 'dt_berkas.tanggal_selesai'
                    },
                    {
                        data: 'lama_pengerjaan',
                        name: 'dt_berkas.lama_pengerjaan'
                    },
                ],
                order: [],
                columnDefs: [ 
